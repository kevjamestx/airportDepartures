...
class Departure:
    ...
    aircraft_classification_dict = {
        ...
        'ABM': 'S', 'M11': 'H', 'B742': 'H', 'A333': 'H', '763': 'H', 'A321N': 'L',
        'A220': 'L'
    }
    ...
    def __init__(self, flight_number, actual_departure_time, scheduled_departure_time, aircraft, config):
        ...
        self.aircraft_class = Departure.aircraft_classification_dict.get(aircraft, 'L')
        self.runway_assignment = None

        # Event times
        self.taxi_start_time = None
        self.taxi_end_time = None
        self.on_runway_time = None
        self.off_runway_time = None
        self.total_gate_wait = 0  # Minutes waited at gate
        self.terminalAssignment = None

        # Predicted wheelsup time
        self.predicted_takeoff_time = None
    ...
    def predict_actual_departure_time(self, virtual_queue_length, *runway_queue_lengths):
